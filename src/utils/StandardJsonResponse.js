...
class StandardJsonResponse {
    ...
    /**
     * Constructs a new `StandardJsonResponse` instance.
     *
     * @param {Response} response - The HTTP response object.
     * @param {number} [statusCode=200] - The HTTP status code.
     *
     * @example
     * const response = new StandardJsonResponse(res, 200);
     */
     ...
     *
     * @returns {StandardJsonResponse} The modified `StandardJsonResponse` instance.
     *
     * @example
...
module.exports = StandardJsonResponse;
